...
filepath = "/net/ruchba/local/tmp/2/lahaye/{0}_tseries_lf/{0}_lowf_{1}.nc".format(simul,var)
...
if addtopo:
    gfilename = "/net/ruchba/local/tmp/2/lahaye/prep_LUCKYTO/lucky_grd.nc"
    zfilename = "/net/krypton/data0/project/vortex/lahaye/luckyt_tseries/luckyt_tseries_2Dvars.nc"
